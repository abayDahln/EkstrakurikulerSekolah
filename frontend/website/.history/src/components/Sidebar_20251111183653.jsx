...
export default function Sidebar({ darkMode, activeMenu, setActiveMenu }) {
	...
	const handleProfileClick = () => {
		// Hanya navigate, tidak mengubah activeMenu
		navigate("/profile");
	};
	...
	const menuItems = [
		...
		{ id: 6, icon: <FaUser />, label: "My Profile" },
	];
	...
	return (
      ...
      `}
			...
			{/* User Info */}
			<div
				className={`p-5 border-t flex items-center gap-3 cursor-pointer transition-colors ${
					darkMode 
