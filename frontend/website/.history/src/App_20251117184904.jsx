...
const useTokenValidation = () => {
	...
	const shouldShowSidebar = useState(!hideSidebarRoutes.includes(location.pathname));
		...
		<BrowserRouter>
			<div className={darkMode ? "dark" : "light"}>
				...
				>
					...
					/>
					{shouldShowSidebar && (
						<Sidebar darkMode={darkMode} initialMenu={1} />
					)}
					...
					<main 
						className="pt-16"
						style={{
							marginLeft: sessionManager.getToken() ? "280px" : "0",
						}}
					>
						<Routes>
							<Route
