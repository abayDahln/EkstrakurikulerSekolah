          ...
          <div className="max-w-5xl mx-auto">
            ...
            {isServerDown || !profileData ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Profile Card - Kiri - Tinggi = 2x card kanan */}
                <div className={`rounded-2xl shadow-lg p-6 ${darkMode ? 'bg-slate-800' : 'bg-white'} lg:row-span-2`}>
                  <div className="text-center">
                    ...
                    <div className={`mt-6 pt-6 border-t ${darkMode ? 'border-slate-700' : 'border-slate-200'}`}>
                      <p className={`text-xs flex items-center justify-center gap-1 mb-1 ${darkMode ? 'text-slate-500' : 'text-slate-400'}`}>
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  {/* Ekstrakurikuler yang Dikelola - Card Paling Bawah Full Width */}
                  <div className={`rounded-2xl shadow-lg p-6 ${darkMode ? 'bg-slate-800' : 'bg-white'} lg:col-span-3`}>
